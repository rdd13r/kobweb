 ...
 * @param apiStreamMethods A collection of methods annotated with `@ApiStream` and relevant metadata.
 */
@Serializable
class BackendData(val initMethods: List<InitApiEntry>, val apiMethods: List<ApiEntry>, val apiStreamMethods: List<ApiStreamEntry>)
